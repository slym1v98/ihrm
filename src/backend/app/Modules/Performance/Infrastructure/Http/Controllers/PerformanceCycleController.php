...
class PerformanceCycleController extends Controller
{
    ...
    {
        try {
            $this->activateHandler->handle(new ActivateCycleCommand($id));
    ...
    {
        try {
            $this->completeHandler->handle(new CompleteCycleCommand($id));
    ...
    {
        try {
            $this->cancelHandler->handle(new CancelCycleCommand($id));
