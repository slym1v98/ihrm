...
class LeaveBalance
{
    ...
    public function id(): LeaveBalanceId
    {
        return $this->id;
    }
    ...
    public function carriedOver(): int
    {
    ...
    {
        return $this->opening + $this->accrued - $this->used - $this->expired - $this->carriedOver;
    }

    public function deduct(int $minutes): LeaveBalanceAdjusted
    {
        ...
        return new LeaveBalanceAdjusted(['balance_id' => $this->id->value(), 'previous_used' => $old, 'new_used' => $this->used]);
    }

    public function restore(int $minutes): LeaveBalanceAdjusted
    {
        $old = $this->used;
        $this->used = max(0, $this->used - $minutes);
