...
class LeavePolicy
{
    ...
    public function id(): LeavePolicyId
    {
        return $this->id;
    }
    ...
    public function carryOverLimit(): ?int
    {
        return $this->carryOverLimit;
    }

    public function carryOverExpiryMonths(): ?int
    {
        return $this->carryOverExpiryMonths;
    }

    public function halfDayAllowed(): bool
    {
        return $this->halfDayAllowed;
    }

    public function hourlyAllowed(): bool
    {
        return $this->hourlyAllowed;
    }

    public function isValidForDate(CarbonImmutable $date): bool
    {
        return $date->gte($this->validFrom) && ($this->validUntil === null || $date->lte($this->validUntil));
    }

    public function allowsDuration(DurationUnit $unit): bool
    {
        return match ($unit) {
            DurationUnit::DAY => true, DurationUnit::HALF_DAY => $this->halfDayAllowed, DurationUnit::HOUR => $this->hourlyAllowed
        };
    }
}
