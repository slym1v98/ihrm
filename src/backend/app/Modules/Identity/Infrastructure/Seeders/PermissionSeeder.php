...
class PermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['workflow.delegation.create', 'workflow-delegation.create', 'Create workflow delegation'],
            ['workflow.delegation.view', 'workflow-delegation.view', 'View workflow delegations'],
            ['workflow.delegation.delete', 'workflow-delegation.delete', 'Delete workflow delegation'],
