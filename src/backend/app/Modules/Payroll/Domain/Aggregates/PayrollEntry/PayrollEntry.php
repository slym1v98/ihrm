...
class PayrollEntry
{
    ...
    public function getId(): PayrollEntryId
    {
        return $this->id;
    }

    public function getRunId(): PayrollRunId
    {
        return $this->runId;
    }
    ...
    public function getContractSnapshot(): array
    {
        return $this->contractSnapshot;
    }

    public function getAttendanceSnapshot(): array
    {
        return $this->attendanceSnapshot;
    }

    public function getLeaveSnapshot(): array
    {
        return $this->leaveSnapshot;
    }
