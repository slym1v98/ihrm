...
class WorkflowTemplateStepModel extends Model
{
    ...
    protected $fillable = ['id', 'workflow_template_id', 'step_order', 'name', 'assignee_type', 'assignee_id', 'condition', 'resolver_type', 'resolver_config', 'execution_type', 'escalation_sla_hours', 'escalation_target_type', 'escalation_target_config'];
