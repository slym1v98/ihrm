...
class HolidayCalendarController
{
    ...
    public function store(StoreHolidayCalendarRequest $request, HolidayCalendarRepositoryInterface $calendars): JsonResponse { return response()->json(['data' => new HolidayCalendarResource($calendars->saveCalendar($request->validated())->load('holidays'))], 201); }
